<div>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ url('public/assets/img/slider-1.jpg') }}" class="d-block d-sm-none" alt="...">
            <img src="{{ url('public/assets/img/slider-1.jpg') }}" class="d-none d-sm-block" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ url('public/assets/img/slider-2.webp') }}" class="d-block d-sm-none" alt="...">
            <img src="{{ url('public/assets/img/slider-2.webp') }}" class="d-none d-sm-block" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ url('public/assets/img/slider-3.jpg') }}" class="d-block d-sm-none" alt="...">
            <img src="{{ url('public/assets/img/slider-3.jpg') }}" class="d-none d-sm-block" alt="...">
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        ...
                        <a href="/pesan-ambulance" class="stretched-link"></a>
                    </div>
                </div>
            </div>
        </div>
